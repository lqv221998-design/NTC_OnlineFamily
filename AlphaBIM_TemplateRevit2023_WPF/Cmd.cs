...
namespace AlphaBIM
{
    ...
    public class $safeprojectname$Cmd : IExternalCommand
    {
            ...
            ref string message, ElementSet elements)
        {
            ...
            {
              tranGroup.Start("$safeprojectname$TransGr");

              $safeprojectname$ViewModel viewModel = new $safeprojectname$ViewModel(uidoc);
              $safeprojectname$Window window = new $safeprojectname$Window(viewModel);
